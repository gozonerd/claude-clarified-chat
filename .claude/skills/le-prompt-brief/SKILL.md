...
| **Real-World Domain/Context** | The authentic context that examples, data, and practice scenarios should be pulled from. Must be relevant to the learner's actual work or interests. | "Stahl Systems agent infrastructure — searching and indexing AI pipeline outputs" |
