...
- When the user invokes `/write-avd` or an equivalent trigger
...
PRD and TRD must exist and be approved. If either missing, refuse to proceed and offer to invoke the appropriate skill first.
